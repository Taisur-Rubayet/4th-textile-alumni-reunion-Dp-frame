...
cropBtn.addEventListener('click', () => {
  ...
  function finalize() {
    ...
    const frameHeight = (frame.naturalHeight / frame.naturalWidth) * canvas.width;
    const frameY = canvas.height - frameHeight;
    ctx.drawImage(frame, 0, frameY, frameWidth, frameHeight);
...
downloadBtn.addEventListener('click', () => {
  ...
  link.download = 'Mega_Reunion_DP.png';
